...
def common_args():
    ...
    parser.add_argument("--save-wp-tokens", default="wp_tokens.json", type=str)

    parser.add_argument("--sp-pred", action="store_true", help="whether to predict sentence sp")
    parser.add_argument("--gene_init_checkpoint",
                        default="bert-base-uncased", type=str)
    parser.add_argument("--simple_init_checkpoint",
                        default="bert-base-uncased", type=str)
    return parser
...
def train_args():
    ...
    parser.add_argument("--sp-lambda", default=5, type=float, help="weight of the sp loss")
    parser.add_argument("--label_smoothing_factor", default=0.0, type=float, help="label smoothing factor.")
    parser.add_argument("--accumulate_gradients", type=int, default=1,
                        help="Number of steps to accumulate gradient on (divide the batch_size and accumulate)")
    parser.add_argument("--train_ques_ans_file", type=str, help="", default="")
    parser.add_argument("--val_ques_ans_file", type=str, help="", default="")
    parser.add_argument("--ques_ans_file_dir", type=str, help="", default="")
