...
class StepQADataset(Dataset):
    ...
    def __init__(self,
        ...
        with open(first_ans_file, "r") as r_f_2:
            self.first_ans_data = json.load(r_f_2)
        ...
        if not train:
            ...
            for i, sample in tqdm(enumerate(self.data)):
                ...
                pre_text = "HOP=2 [SEP] " + question + " [BRIDGE] " + self.first_ans_data[sample["_id"]] + " [SUB] " + self.first_ques_data[i]["question"] 
